...
public class SshClientUtilTest {
    ...
    public void testEncryptDecryptUriWithNoPassword() {
        ...
        String encrypted = SshClientUtils.encryptSshPathAsNecessary(uri);
        String decrypted = SshClientUtils.decryptSshPathAsNecessary(encrypted);

        assertEquals(uri, encrypted);
        assertEquals(uri, decrypted);
    }
